...
namespace model_iar_incl_prob_notau_namespace {
...
static constexpr std::array<const char*, 23> locations_array__ =
  ...
  " (in 'string', line 27, column 2 to column 37)",
  ...
  " (in 'string', line 7, column 69 to line 10, column 2)"};
...
class model_iar_incl_prob_notau final : public model_base_crtp<model_iar_incl_prob_notau> {
private:
  int J;
  int J_edges;
...
public:
  ~model_iar_incl_prob_notau() {}
  model_iar_incl_prob_notau(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "model_iar_incl_prob_notau_namespace::model_iar_incl_prob_notau";
    // suppress unused var warning
    (void) function__;
    local_scalar_t__ DUMMY_VAR__(std::numeric_limits<double>::quiet_NaN());
    // suppress unused var warning
  ...
  inline std::string model_name() const final {
    return "model_iar_incl_prob_notau";
  }
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_iar_incl_prob_notau_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_iar_incl_prob_notau_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
...
using stan_model = model_iar_incl_prob_notau_namespace::model_iar_incl_prob_notau;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_iar_incl_prob_notau_namespace::profiles__;
}
#endif
#endif
