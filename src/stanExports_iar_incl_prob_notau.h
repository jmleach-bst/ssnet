...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_iar_incl_prob_notau");
    reader.add_event(30, 28, "end", "model_iar_incl_prob_notau");
    return reader;
}
...
icar_normal_lpdf(const Eigen::Matrix<T0__, Eigen::Dynamic, 1>& psi,
                     ...
                     const std::vector<int>& node1,
                     const std::vector<int>& node2, std::ostream* pstream__) {
    return icar_normal_lpdf<false>(psi,J,node1,node2, pstream__);
}
struct icar_normal_lpdf_functor__ {
    ...
    operator()(const Eigen::Matrix<T0__, Eigen::Dynamic, 1>& psi,
        ...
        return icar_normal_lpdf(psi, J, node1, node2, pstream__);
    }
};
#include <stan_meta_header.hpp>
class model_iar_incl_prob_notau
  : public stan::model::model_base_crtp<model_iar_incl_prob_notau> {
private:
        int J;
        int J_edges;
        ...
        vector_d p;
public:
    model_iar_incl_prob_notau(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_iar_incl_prob_notau_namespace::model_iar_incl_prob_notau";
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            lp_accum__.add(icar_normal_lpdf<propto__>(psi, J, node1, node2, pstream__));
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
            throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***");
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_iar_incl_prob_notau_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_iar_incl_prob_notau_namespace::model_iar_incl_prob_notau stan_model;
#ifndef USING_R
