...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_iar_incl_prob_manual_tau");
    reader.add_event(31, 29, "end", "model_iar_incl_prob_manual_tau");
    return reader;
}
...
class model_iar_incl_prob_manual_tau
  : public stan::model::model_base_crtp<model_iar_incl_prob_manual_tau> {
private:
        int J;
        int J_edges;
...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_iar_incl_prob_manual_tau_namespace::model_iar_incl_prob_manual_tau";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_iar_incl_prob_manual_tau_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_iar_incl_prob_manual_tau_namespace::model_iar_incl_prob_manual_tau stan_model;
#ifndef USING_R
