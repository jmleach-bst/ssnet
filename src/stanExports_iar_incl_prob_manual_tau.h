...
namespace model_iar_incl_prob_manual_tau_namespace {
...
class model_iar_incl_prob_manual_tau final : public model_base_crtp<model_iar_incl_prob_manual_tau> {
private:
  int J;
  int J_edges;
...
public:
  ~model_iar_incl_prob_manual_tau() {}
  model_iar_incl_prob_manual_tau(stan::io::var_context& context__,
    ...
    static constexpr const char* function__ =
      "model_iar_incl_prob_manual_tau_namespace::model_iar_incl_prob_manual_tau";
    // suppress unused var warning
    (void) function__;
    local_scalar_t__ DUMMY_VAR__(std::numeric_limits<double>::quiet_NaN());
    // suppress unused var warning
  ...
  inline std::string model_name() const final {
    return "model_iar_incl_prob_manual_tau";
  }
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_iar_incl_prob_manual_tau_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_iar_incl_prob_manual_tau_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  get_param_names(std::vector<std::string>& names__, const bool
    ...
    names__ = std::vector<std::string>{"psi"};
    if (emit_transformed_parameters__) {
  ...
  inline std::string get_constrained_sizedtypes() const {
    return std::string("[{\"name\":\"psi\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(J) + "},\"block\":\"parameters\"},{\"name\":\"theta\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(J) + "},\"block\":\"transformed_parameters\"}]");
  }
...
using stan_model = model_iar_incl_prob_manual_tau_namespace::model_iar_incl_prob_manual_tau;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_iar_incl_prob_manual_tau_namespace::profiles__;
}
#endif
#endif
