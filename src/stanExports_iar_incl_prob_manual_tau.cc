...
#include "stanExports_iar_incl_prob_manual_tau.h"

RCPP_MODULE(stan_fit4iar_incl_prob_manual_tau_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_iar_incl_prob_manual_tau")
