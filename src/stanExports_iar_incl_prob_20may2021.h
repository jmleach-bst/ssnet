...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_iar_incl_prob_20may2021");
    reader.add_event(21, 19, "end", "model_iar_incl_prob_20may2021");
    return reader;
}
...
class model_iar_incl_prob_20may2021
  : public stan::model::model_base_crtp<model_iar_incl_prob_20may2021> {
private:
        int J;
        int J_edges;
...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_iar_incl_prob_20may2021_namespace::model_iar_incl_prob_20may2021";
        ...
        try {
            ...
            psi = Eigen::Matrix<double, Eigen::Dynamic, 1>(J);
            stan::math::fill(psi, DUMMY_VAR__);
            stan::math::assign(psi,logit(p));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_iar_incl_prob_20may2021_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_iar_incl_prob_20may2021_namespace::model_iar_incl_prob_20may2021 stan_model;
#ifndef USING_R
