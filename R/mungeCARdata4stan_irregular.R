...
#' @return Returns a list where \code{J} is the number predictors,
...
#' @note  This function is derivative from Mitzi Morris's code
...
#' @export
mungeCARdata4stan_irregular <- function(
    adjBUGS,
    numBUGS
){
  J <- length(numBUGS)
