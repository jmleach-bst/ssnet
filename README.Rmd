...
[![R build status](https://github.com/jmleach-bst/ssnet/workflows/R-CMD-check/badge.svg)](https://github.com/jmleach-bst/ssnet/actions)
<!-- badges: end -->

The goal of `ssnet` is to fit spike-and-slab elastic net GLM's with or without spatially structured priors. An expectation maximization (EM) algorithm is used to fit the models, and spatial structure is incorporated by using Intrinsic Autoregressions (IAR) as priors for inclusion probabilities.
